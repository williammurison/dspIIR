...
board.analog[5].register_callback(callBack0)

# Enable the callback
board.analog[5].enable_reporting()

board.analog[4].register_callback(callBack1)
board.analog[4].enable_reporting()

board.analog[3].register_callback(callBack2)
board.analog[3].enable_reporting()

board.analog[2].register_callback(callBack3)
